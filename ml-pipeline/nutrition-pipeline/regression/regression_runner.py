...
def parse_meal_text_to_ingredients(text: str, tier: str | None = None, flow: str | None = None) -> list[dict]:
    """
    ...
    flow: "name_first" = parse then USDA lookup (default). "gpt_first" = parse+nutrition in one GPT call, then USDA closest-match to estimate.
    Default flow from env PARSE_FLOW or "name_first".
